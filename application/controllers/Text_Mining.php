<?php
		...
		include('application/libraries/text_mining/class.pdf2text.php');
		include_once 'application/libraries/text_mining/IDNstemmer.php';
		include('application/libraries/text_mining/Enhanced_CS.php');
		...
		//$st->doStemming($filteredarray)
		 ...
		 $query = "INSERT INTO dokumen (nama_file, token)
		         ...
		         //echo ">>".$query;   //menampilkan hasil text mining
		...
		$folder = "upload/proses/$nama_file";
		// tanggal sekarang
		$tgl_upload = date("Ymd");
		// Apabila file berhasil di upload
		if (move_uploaded_file($lokasi_file,"$folder")){
		  //echo "<br> Nama File : <b>$nama_file</b> sukses di upload";
		  //$this->load->view('account/admin/dashboard');
		  
			//$msg = "DONE";
			//echo "<script type='text/javascript'>alert('$msg');</script>";
			//header('Location: /application/views/account/admin/dashboard.php');
		 ...
		 $nama_file="./upload/proses/".$nama_file;
		    //echo ">>>>>>>>>>>>>>>>".$nama_file;
		...
		//print_r($tekspdf); //menampilkan hasil pdf2text
		...
		//echo "<script type='text/javascript'> alert('DONE!');
					//document.location='sukses.php';</script>";
