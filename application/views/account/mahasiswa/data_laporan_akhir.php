  ...
  <div class="content-wrapper">
    ...
    <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> History Laporan Akhir</div>
        <div class="card-body">
            ...
            <table class="table table-bordered table-striped" width="100%" cellspacing="0">
				...
				<tbody>
					...
					?>
						...
						<td><?php echo $row->lap_akhir; ?></td>
						<td><?php echo $row->nilai; ?></td>	
						<td><?php echo $row->upload_at; ?></td>		
						
						<td>
							<a href="<?php echo base_url(); ?>mahasiswa/download_laporan_akhir/<?php echo $row->lap_akhir; ?>" class="btn btn-primary btn-sm fa fa fa-download" title="Download Laporan Akhir" data-toggle="tooltip"></a>
							<a href="<?php echo site_url('mahasiswa/delete_laporan_akhir/'.$row->id_lap_akhir); ?>" class="btn btn-danger btn-sm fa fa-trash" onClick="hapus()" title="Delete" data-toggle="tooltip"></a>
						</td>
