...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="<?php echo base_url('main/dosen'); ?>">Welcome, <?php echo $this->session->userdata('namalengkap')?></a>
    ...
    <!-- Isi --> 
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Daftar Dosen Pembimbing</div>
        <div class="card-body">
