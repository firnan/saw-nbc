...
<head>
  ...
  <link href="<?php echo base_url() ?>assets/sweet-alert/sweetalert.css" rel="stylesheet">
</head>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
        ...
        <div class="card-body">
          <div class="table-responsive">
			...
			<tr>
				...
				<td> <?php echo $key->konsentrasi ?> </td>
				...
				<td>
					<a href="<?php echo base_url() ?>olahdata/details/<?php echo $key->id_mhs ?>" class="btn btn-info fa fa-pencil item_edit" title="View Details" data-toggle="tooltip"></a>
					<a href="<?php echo base_url() ?>olahdata/olah_proposal/<?php echo $key->id_mhs ?>" class="btn btn-info fa fa-file-pdf-o item_edit" title="Olah Proposal" data-toggle="tooltip"></a>
					<a href="<?php echo base_url() ?>olahdata/olah_pembimbing/<?php echo $key->id_mhs ?>" class="btn btn-info fa fa-adjust item_edit" title="Olah Pembimbing" data-toggle="tooltip"></a>
					<a href="<?php echo base_url() ?>olahdata/delete/<?php echo $key->id_mhs ?>" class="btn btn-danger fa fa-trash item_edit" title="Delete" data-toggle="tooltip" onClick="return doconfirm();"></a>
				</td>
			</tr>
			<?php } ?>
              </tbody>
    ...
    <script>
		function doconfirm()
		{
		    job=confirm("Apakah Anda yakin mau menghapus Data Mahasiswa ini?");
		    if(job!=true)
		    {
		        return false;
		    }
