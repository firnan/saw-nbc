  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Olah Proposal</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-edit"></i> Data Proposal Mahasiswa</div>
        <div class="card-body">
          <div class="table-responsive">
            
          	<form action="/myskripsi/olahdata/hasil_proposal" method="post" enctype="multipart/form-data" style="margin-top:0px;">
	          	<div class="form-group">
				    <label class="control-label col-xs-3"><b>NIM</b></label>
			        <div class="col-xs-9">
					    <input type="text" name="nim" value="<?php echo $data_proposal->nim; ?>" class="form-control" style="width:460px;" onkeyup="isi_otomatis()" id="nim">
					    <input type="hidden" value="<?php echo $data_proposal->id_mhs ?>" name="id_mhs">
					</div> 
				</div>
				<div class="form-group">
				    <label class="control-label col-xs-3"><b>Judul</b></label>
			        <div class="col-xs-9">
					    <input type="text" name="nim" value="<?php echo $data_proposal->judul; ?>" class="form-control" style="width:460px;">
					    <input type="hidden" value="<?php echo $data_proposal->id_mhs ?>" name="id_mhs">
					</div> 
				</div>
				<div class="form-group">
	                ...
	                <div class="col-xs-9">
	                	<select name="konsentrasi" id="konsentrasi" class="form-control" style="width:460px;" reqired>
	                        <option value="<?php echo $data_proposal->konsentrasi ?>">--<?php echo $data_proposal->konsentrasi ?>--</option>
			...
			<div class="form-group">
			    <label class="control-label col-xs-3" ><b>Nama Proposal</b></label>
		        <div class="col-xs-9">
		        <input name="dokn" value="<?php echo $judul_proposal = $data_proposal->proposal; ?>" class="form-control" style="width:460px;" readonly>
		        <div class="col-xs-9">
		        	
			</div></div></div>

        	<!--<input type="file" id="exampleInputFile" name="dokn" value="<?php echo $data_proposal->proposal ?>" id="proposal" >-->
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
        <script type="text/javascript">
            function isi_otomatis(){
                var nim = $("#nim").val();
                $.ajax({
                    url: 'myskripsi/application/views/account/admin/proses-ajax.php',
                    data:"nim="+nim ,
