          ...
          <ul class="sidenav-second-level collapse" id="collapseMahasiswa">
        	...
        	<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Link">
          	<a class="nav-link" href="<?php echo base_url('main/olah_data'); ?>">
            	<i class="fa fa-fw fa fa fa-check-circle-o"></i>
        ...
        <div class="card-body">
          <div class="table-responsive">
			...
			<div class="form-group">
			    <label class="control-label col-xs-3" ><b>Judul Proposal</b></label>
		        <div class="col-xs-9">
		        <input type="text" name="judul" value="<?php echo $data_proposal->proposal ?>" class="form-control" style="width:460px;" readonly><div class="col-xs-9">
			...
			<div class="form-group">
                ...
                <div class="col-xs-9">
                <select name="pembimbing_1" id="pembimbing1" class="form-control" style="width:460px;" required>
			...
			<div class="form-group">
                ...
                <div class="col-xs-9">
                <select name="pembimbing_2" id="pembimbing1" class="form-control" style="width:460px;" required>
			...
			<input class="btn btn-primary" style="display:block; margin:20px auto;" type="submit" value="SUBMIT" name="proses" />
          </div></div>
        </div>
      </div>
    </div>
