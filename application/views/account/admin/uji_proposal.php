    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-upload"></i> Upload Dokumen Uji</div>
        <div class="card-body">
          <div class="table-responsive">
            
          	
          	<div class="content"> 
        	<h6 style="color:steelblue;" >Silahkan Masukkan Dokumen (pdf)</h6>
            <form action="uji_proposal" method="post" enctype="multipart/form-data" style="margin-top:30px;">
                <input type="file" id="exampleInputFile" name="dokn" required>
