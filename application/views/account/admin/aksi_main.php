  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Hasil Analisis Proposal</li>
      </ol>
          	...
          	<form action="uji_saw" method="post" enctype="multipart/form-data">
          		<div class="auto">
					<label class="control-label col-xs-3" ><b>Konsentrasi:</b></label>
		        		<div class="col-xs-9">
							<input type="text" name="judul" value="<?php echo $category; ?>" class="form-control" style="width:300px;" readonly><br>
