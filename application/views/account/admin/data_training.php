...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Isi Konten -->
      		<form action="/myskripsi/olahdata/hasil_datatraining" method="post" enctype="multipart/form-data" style="margin-top:0px;">
      			<center><label><b>Masukkan Data Training</b></label></center>
          		<center><input type="file" name="dokn" class="form-control" style="width:460px;"></center>
          		<input class="btn btn-primary" style="display:block; margin:20px auto;" type="submit" value="PROSES" name="proses1" />
          	</form>
          	
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Tabel Data Training</div>
        <div class="card-body">
