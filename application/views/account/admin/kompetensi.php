  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Kriteria Kompetensi</li>
      </ol>
	  ...
	  <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/css/jquery.dataTables.css'?>">
			...
			<!-- Page Heading -->
		            <h3>Bobot Kriteria
						...
						<div class="form-action text-left">
		                	<a href="#" class="btn btn-sm btn-success" data-toggle="modal"data-target="#ModalaAdd"><span class="fa fa-plus"></span> Tambah Kompetensi</a>&nbsp;&nbsp;&nbsp;
				...
				<table class="table table-striped table-bordered" cellspacing="0" width="100%" id="mydata">
					<thead>
						<tr>
							...
							<th style="text-align: center;">Strategi PR</th>
							<th style="text-align: center;">Pemasaran</th>
							<th style="text-align: center;">Organisasi</th>
							<th style="text-align: center;">Semiotika</th>
							<th style="text-align: center;">Branding</th>
							<th style="text-align: center;">Politik</th>
							<th style="text-align: center;">Media</th>
							<th style="text-align: center;">Budaya</th>
							<th style="text-align: center;">Radio, TV, Film</th>
		        ...
		        <div class="modal fade" id="ModalaAdd" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
		            ...
		            <form class="form-horizontal">
		                <div class="modal-body">
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >CSR</label>
		                        <div class="col-xs-9">
		                        	<select name="csr" id="csr" class="form-control" style="width:460px;" required>
                        	...
                        	<div class="form-group">
		                        <label class="control-label col-xs-3" >Strategi PR</label>
		                        <div class="col-xs-9">
		                            <select name="strategi_pr" id="strategi_pr" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Pemasaran</label>
		                        <div class="col-xs-9">
		                            <select name="pemasaran" id="pemasaran" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Organisasi</label>
		                        <div class="col-xs-9">
		                            <select name="organisasi" id="organisasi" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Semiotika</label>
		                        <div class="col-xs-9">
		                            <select name="semiotika" id="semiotika" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Branding</label>
		                        <div class="col-xs-9">
		                            <select name="branding" id="branding" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Politik</label>
		                        <div class="col-xs-9">
		                            <select name="politik" id="politik" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="col-xs-9">
		                            <select name="media" id="media" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Budaya</label>
		                        <div class="col-xs-9">
		                            <select name="budaya" id="budaya" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Radio, TV, Film</label>
		                        <div class="col-xs-9">
		                            <select name="radio_tv_film" id="radio_tv_film" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
		            ...
		            <form class="form-horizontal">
		                <div class="modal-body">
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >CSR</label>
		                        <div class="col-xs-9">
		                            <select name="csr_edit" id="csr2" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
                        	...
                        	<div class="form-group">
		                        <label class="control-label col-xs-3" >Strategi PR</label>
		                        <div class="col-xs-9">
		                            <select name="strategi_pr_edit" id="strategi_pr2" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Pemasaran</label>
		                        <div class="col-xs-9">
		                            <select name="pemasaran_edit" id="pemasaran2" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Organisasi</label>
		                        <div class="col-xs-9">
		                            <select name="organisasi_edit" id="organisasi2" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Semiotika</label>
		                        <div class="col-xs-9">
									<select name="semiotika_edit" id="semiotika2" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Branding</label>
		                        <div class="col-xs-9">
		                            <select name="branding_edit" id="branding2" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Politik</label>
		                        <div class="col-xs-9">
		                            <select name="politik_edit" id="politik2" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Media</label>
		                        <div class="col-xs-9">
		                            <select name="media_edit" id="media2" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Budaya</label>
		                        <div class="col-xs-9">
		                            <select name="budaya_edit" id="budaya2" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Radio, TV, Film</label>
		                        <div class="col-xs-9">
		                            <select name="radio_tv_film_edit" id="radio_tv_film2" class="form-control" style="width:460px;" required>
				                        <option value="1">1</option>
				                        <option value="0.83">0.83</option>
				                        <option value="0.67">0.67</option>
				                        <option value="0.5">0.5</option>
		            ...
		            <div class="modal-dialog" role="document">
		                <div class="modal-content">
		                    ...
		                    <div class="modal-body">     
		                        ...
		                        <div class="alert alert-warning"><p>Apakah Anda yakin mau menghapus Data Kompetensi ini?</p></div>
		                    </div>
		                    <div class="modal-footer">
		...
		<script type="text/javascript">
			$(document).ready(function(){
				tampil_data_kompetensi();	//pemanggilan fungsi tampil barang.
				
						$('#mydata').dataTable();
						 
						//fungsi tampil barang
						function tampil_data_kompetensi(){
				    	$.ajax({
				        type  : 'ajax',
				        url   : '<?php echo base_url()?>metode_saw/data_kompetensi',
				        async : false,
				        dataType : 'json',
				        success : function(data){
				            ...
				            for(i=0; i<data.length; i++){
				                html += '<tr>'+
				                        ...
				                        '<td>'+data[i].csr+'</td>'+
				                        '<td>'+data[i].strategi_pr+'</td>'+
				                        '<td>'+data[i].pemasaran+'</td>'+
				                        '<td>'+data[i].organisasi+'</td>'+
				                        '<td>'+data[i].semiotika+'</td>'+
				                        '<td>'+data[i].branding+'</td>'+
				                        '<td>'+data[i].politik+'</td>'+
				                        '<td>'+data[i].media+'</td>'+
				                        '<td>'+data[i].budaya+'</td>'+
				                        '<td>'+data[i].radio_tv_film+'</td>'+
				...
				$('#show_data').on('click','.item_edit',function(){
		            var nama_dosen=$(this).attr('data');
		            $.ajax({
		                type : "GET",
		                url  : "<?php echo base_url('metode_saw/get_kompetensi')?>",
		                dataType : "JSON",
		                data : {nama_dosen:nama_dosen},
		                success: function(data){
		                	$.each(data,function(nama_dosen, csr,$strategi_pr, pemasaran, organisasi, semiotika, branding, politik, media, budaya, radio_tv_film){
		                    	$('#ModalaEdit').modal('show');
		            			$('[name="nama_dosen_edit"]').val(data.nama_dosen);
		            			$('[name="csr_edit"]').val(data.csr);
		            			$('[name="strategi_pr_edit"]').val(data.strategi_pr);
		            			$('[name="pemasaran_edit"]').val(data.pemasaran);
		            			$('[name="organisasi_edit"]').val(data.organisasi);
		            			$('[name="semiotika_edit"]').val(data.semiotika);
		            			$('[name="branding_edit"]').val(data.branding);
		            			$('[name="politik_edit"]').val(data.politik);
		            			$('[name="media_edit"]').val(data.media);
		            			$('[name="budaya_edit"]').val(data.budaya);
		            			$('[name="radio_tv_film_edit"]').val(data.radio_tv_film)
		            		});
		                }
		            });
		            return false;
				...
				$('#btn_simpan').on('click',function(){
		            ...
		            var csr=$('#csr').val();
		            var strategi_pr=$('#strategi_pr').val();
		            var pemasaran=$('#pemasaran').val();
		            var organisasi=$('#organisasi').val();
		            var semiotika=$('#semiotika').val();
		            var branding=$('#branding').val();
		            var politik=$('#politik').val();
		            var media=$('#media').val();
		            var budaya=$('#budaya').val();
		            var radio_tv_film=$('#radio_tv_film').val();
		            $.ajax({
		                type : "POST",
		                url  : "<?php echo base_url('metode_saw/simpan_kompetensi')?>",
		                dataType : "JSON",
		                data : {nama_dosen:nama_dosen, csr:csr, strategi_pr:strategi_pr, pemasaran:pemasaran, organisasi:organisasi, semiotika:semiotika, branding:branding, politik:politik, media:media, budaya:budaya, radio_tv_film:radio_tv_film},
		                success: function(data){
		                    $('[name="nama_dosen"]').val("");
		                    $('[name="csr"]').val("");
		                    $('[name="strategi_pr"]').val("");
		                    $('[name="pemasaran"]').val("");
		                    $('[name="organisasi"]').val("");
		                    $('[name="semiotika"]').val("");
		                    $('[name="branding"]').val("");
		                    ...
		                    $('[name="media"]').val("");
		                    $('[name="budaya"]').val("");
		                    $('[name="radio_tv_film"]').val("");
		                    $('#ModalaAdd').modal('hide');
		                    tampil_data_kompetensi();
		                }
		            });
		            return false;
		        });
				...
				$('#btn_update').on('click',function(){
		            ...
		            var csr=$('#csr2').val();
		            var strategi_pr=$('#strategi_pr2').val();
		            var pemasaran=$('#pemasaran2').val();
		            var organisasi=$('#organisasi2').val();
		            var semiotika=$('#semiotika2').val();
		            var branding=$('#branding2').val();
		            var politik=$('#politik2').val();
		            var media=$('#media2').val();
		            var budaya=$('#budaya2').val();
		            var radio_tv_film=$('#radio_tv_film2').val();
		            $.ajax({
		                type : "POST",
		                url  : "<?php echo base_url('metode_saw/update_kompetensi')?>",
		                dataType : "JSON",
		                data : {nama_dosen:nama_dosen, csr:csr, strategi_pr:strategi_pr, pemasaran:pemasaran, organisasi:organisasi, semiotika:semiotika, branding:branding, politik:politik, media:media, budaya:budaya, radio_tv_film:radio_tv_film},
		                success: function(data){
		                    $('[name="nama_dosen"]').val("");
		        ...
		        $('#btn_hapus').on('click',function(){
		            var kode2=$('#textkode2').val();
		            $.ajax({
		            type : "POST",
		            url  : "<?php echo base_url('metode_saw/hapus_kompetensi')?>",
		            dataType : "JSON",
		                    data : {kode2: kode2},
		                    success: function(data){
