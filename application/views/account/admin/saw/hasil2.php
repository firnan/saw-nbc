<div class="page-title">
				<h5><i class="fa fa-desktop"></i> Hasil Analisa Dosen Pembimbing 2</h5>
			</div>
			...
			<div class="datatable">
				<?php 
            		...
            		$konsen = $_POST['bobot_konsentrasi'];
	            		if ($konsen == "1") {
	            			echo "&nbsp;&nbsp;";echo round($dataku['broadcast']/$max['max2'],2);
	            			echo "&nbsp;&nbsp;";echo round($dataku['jurnal']/$max['max3'],2);
	            			echo "&nbsp;&nbsp;";echo round($dataku['pr']/$max['max4'],2);
	            			echo "&nbsp;&nbsp;";echo round($dataku['other']/$max['max5'],2);
	            		} elseif ($konsen == "2") {
	            			echo "&nbsp;&nbsp;";echo round($dataku['advert']/$max['max1'],2);
	            			echo "&nbsp;&nbsp;";echo round($dataku['jurnal']/$max['max3'],2);
	            			echo "&nbsp;&nbsp;";echo round($dataku['pr']/$max['max4'],2);
	            			echo "&nbsp;&nbsp;";echo round($dataku['other']/$max['max5'],2);
	            		} elseif ($konsen == "3") {
            		...
            		$kompetensi = $_POST['bobot_kompetensi'];
	            		if ($kompetensi == "1") {
	            			echo "&nbsp;&nbsp;";echo round($dataku['film']/$max2['max7'],2);
	            			echo "&nbsp;&nbsp;";echo round($dataku['animasi']/$max2['max8'],2);
							echo "&nbsp;&nbsp;";echo round($dataku['papper']/$max2['max9'],2);
							echo "&nbsp;&nbsp;";echo round($dataku['kamera']/$max2['max10'],2);
	            		} elseif ($kompetensi == "2") {
	            			echo "&nbsp;&nbsp;";echo round($dataku['csr']/$max2['max6'],2);
	            			echo "&nbsp;&nbsp;";echo round($dataku['animasi']/$max2['max8'],2);
							echo "&nbsp;&nbsp;";echo round($dataku['papper']/$max2['max9'],2);
							echo "&nbsp;&nbsp;";echo round($dataku['kamera']/$max2['max10'],2);
	            		} elseif ($kompetensi == "3") {
				...
				while ($dataku = mysql_fetch_array($hasil)) {
            		...
            		$kompetensi = $_POST['bobot_kompetensi'];
	            		if ($konsen == "1" && $kompetensi == "1") {
	            			$rangking1 = (($dataku['broadcast']/$max['max2'])*1)+(($dataku['film']/$max2['max6'])*0.5)+(($dataku['fungsional']/$max3['max11'])*0.75)+(($min3['min12']/$dataku['kuota'])*0.75);
