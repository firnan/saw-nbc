  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Data Laporan Akhir</li>
      </ol>
	  ...
	  <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/css/jquery.dataTables.css'?>">
		<div class="container">
			<!-- Page Heading -->
		            <h3>Data
		                <b>Laporan Akhir</b></h3>
						<div class="form-action text-left">
		                	<a href="#" class="btn btn-sm btn-success" data-toggle="modal"data-target="#ModalaAdd"><span class="fa fa-plus"></span> Tambah Laporan Akhir</a>&nbsp;&nbsp;&nbsp;
			...
			<div class="row">
		        ...
		        <div class="modal fade" id="ModalaAdd" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
		            ...
		            <div class="modal-header">
		                <h3 class="modal-title" id="myModalLabel">Tambah Laporan Akhir</h3>
		            ...
		            <form class="form-horizontal">
		                <div class="modal-body">
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="col-xs-9">
		                            <input name="namalengkap" id="namalengkap" class="form-control" type="text" placeholder="Nama Mahasiswa" style="width:460px;" required>
		                        </div>
		                    </div>
                            ...
                            <div class="col-xs-9">
                                <select name="pembimbing1" id="pembimbing1" class="form-control" style="width:460px;" required>
                            ...
                            <div class="col-xs-9">
                                <select name="pembimbing2" id="pembimbing2" class="form-control" style="width:460px;" required>
                                    <option value="">--Pilih Penguji 1--</option>
                                    <option value="Prayudi, MA., PhD">Prayudi, MA., PhD</option>
                                    <option value="Dr. Christina Rochayanti, M.Si">Dr. Christina Rochayanti, M.Si</option>
                                    <option value="Dr. Puji Lestari S, M.Si">Dr. Puji Lestari S, M.Si</option>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >File Laporan Akhir</label>
		                        <div class="col-xs-9">
		                            <input name="lap_akhir" id="lap_akhir" class="form-control" type="file" placeholder="Judul" style="width:460px;" required>
		                        </div>
		                    </div>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="col-xs-9">
		                            <select name="nilai" id="nilai" class="form-control" style="width:460px;" required>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="col-xs-9">
		                            <input name="upload_at" id="upload_at" class="form-control" type="text" placeholder="Jam" style="width:460px;" readonly>
		                        </div>
		                    </div>
		            ...
		            <form class="form-horizontal">
		                <div class="modal-body">
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Nama Mahasiswa</label>
		                        <div class="col-xs-9">
		                            <input name="namalengkap_edit" id="namalengkap2" class="form-control" type="text" placeholder="Nama Mahasiswa" style="width:460px;" required>
		                        </div>
		                    </div>
                            ...
                            <label class="control-label col-xs-3">Pembimbing 1</label>
                            <div class="col-xs-9">
                                <select name="pembimbing1_edit" id="pembimbing1_2" class="form-control" style="width:460px;" required>
                                    <option value="">--Pilih Penguji 1--</option>
                                    <option value="Prayudi, MA., PhD">Prayudi, MA., PhD</option>
                                    <option value="Dr. Christina Rochayanti, M.Si">Dr. Christina Rochayanti, M.Si</option>
                                    <option value="Dr. Puji Lestari S, M.Si">Dr. Puji Lestari S, M.Si</option>
                            ...
                            <label class="control-label col-xs-3">Pembimbing 2</label>
                            <div class="col-xs-9">
                                <select name="pembimbing2_edit" id="pembimbing2_2" class="form-control" style="width:460px;" required>
                                    <option value="">--Pilih Penguji 1--</option>
                                    <option value="Prayudi, MA., PhD">Prayudi, MA., PhD</option>
                                    <option value="Dr. Christina Rochayanti, M.Si">Dr. Christina Rochayanti, M.Si</option>
                                    <option value="Dr. Puji Lestari S, M.Si">Dr. Puji Lestari S, M.Si</option>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >File Laporan Akhir</label>
		                        <div class="col-xs-9">
		                            <input name="lap_akhir_edit" id="lap_akhir2" class="form-control" type="text" placeholder="Judul" style="width:460px;" required>
		                        </div>
		                    </div>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Nilai</label>
		                        <div class="col-xs-9">
		                            <select name="nilai_edit" id="nilai2" class="form-control" style="width:460px;" required>
                                    <option value="">--Pilih Nilai--</option>
                                    <option value="A">A</option>
                                    <option value="B+">B+</option>
                                    <option value="B">B</option>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Upload</label>
		                        <div class="col-xs-9">
		                            <input name="upload_at_edit" id="upload_at2" class="form-control" type="text" placeholder="Jam" style="width:460px;" readonly>
		                        </div>
		                    </div>
		            ...
		            <div class="modal-dialog" role="document">
		                <div class="modal-content">
		                    ...
		                    <div class="modal-body">     
		                        ...
		                        <div class="alert alert-warning"><p>Apakah Anda yakin mau menghapus Data Laporan Akhir ini?</p></div>
		                    </div>
		                    <div class="modal-footer">
		...
		<script type="text/javascript">
			$(document).ready(function(){
				tampil_data_lapakhir();	//pemanggilan fungsi tampil barang.
				
						$('#mydata').dataTable();
						 
						//fungsi tampil barang
						function tampil_data_lapakhir(){
				    	$.ajax({
				        type  : 'ajax',
				        url   : '<?php echo base_url()?>laporan_akhir/data_lapakhir',
				        async : false,
				        dataType : 'json',
				        success : function(data){
				            ...
				            for(i=0; i<data.length; i++){
				                html += '<tr>'+
				                        ...
				                        '<td>'+data[i].judul+'</td>'+
				                        '<td>'+data[i].pembimbing1+'</td>'+
				                        '<td>'+data[i].pembimbing2+'</td>'+
				                        '<td>'+data[i].lap_akhir+'</td>'+
				                        '<td>'+data[i].nilai+'</td>'+
				                        '<td>'+data[i].upload_at+'</td>'+
				...
				$('#show_data').on('click','.item_edit',function(){
		            var id_lap_akhir=$(this).attr('data');
		            $.ajax({
		                type : "GET",
		                url  : "<?php echo base_url('laporan_akhir/get_lapakhir')?>",
		                dataType : "JSON",
		                data : {id_lap_akhir:id_lap_akhir},
		                success: function(data){
		                	$.each(data,function(nim, namalengkap, judul, pembimbing1, pembimbing2, lap_akhir, nilai, upload_at){
		                    	$('#ModalaEdit').modal('show');
		            			$('[name="nim_edit"]').val(data.nim);
		            			$('[name="namalengkap_edit"]').val(data.namalengkap);
		            			$('[name="judul_edit"]').val(data.judul);
		            			$('[name="pembimbing1_edit"]').val(data.pembimbing1);
		            			$('[name="pembimbing2_edit"]').val(data.pembimbing2);
		            			$('[name="lap_akhir_edit"]').val(data.lap_akhir);
		            			$('[name="nilai_edit"]').val(data.tgl);
		            			$('[name="upload_at_edit"]').val(data.upload_at);
		            		});
		                }
		            });
		            return false;
				...
				$('#btn_simpan').on('click',function(){
		            ...
		            var lap_akhir=$('#lap_akhir').val();
		            var nilai=$('#nilai').val();
		            var upload_at=$('#upload_at').val();
		            $.ajax({
		                type : "POST",
		                url  : "<?php echo base_url('laporan_akhir/simpan_lapakhir')?>",
		                dataType : "JSON",
		                data : {nim:nim , namalengkap:namalengkap, judul:judul, pembimbing1:pembimbing1, pembimbing2:pembimbing2, lap_akhir:lap_akhir, nilai:nilai, upload_at:upload_at},
		                success: function(data){
		                    $('[name="nim"]').val("");
				...
				$('#btn_update').on('click',function(){
		            ...
		            var pembimbing1=$('#pembimbing1_2').val();
		            var pembimbing2=$('#pembimbing2_2').val();
		            var lap_akhir=$('#lap_akhir2').val();
		            var nilai=$('#nilai2').val();
		            var upload_at=$('#upload_at2').val();
		            $.ajax({
		                type : "POST",
		                url  : "<?php echo base_url('laporan_akhir/update_lapakhir')?>",
		                dataType : "JSON",
		                data : {nim:nim , namalengkap:namalengkap, judul:judul, pembimbing1:pembimbing1, pembimbing2:pembimbing2, lap_akhir:lap_akhir, nilai:nilai, upload_at:upload_at},
		                success: function(data){
		                    $('[name="nim_edit"]').val("");
		                    $('[name="namalengkap_edit"]').val("");
		                    $('[name="judul_edit"]').val("");
		                    $('[name="pembimbing1_edit"]').val("");
		                    $('[name="pembimbing2_edit"]').val("");
		                    $('[name="lap_akhir_edit"]').val("");
		                    $('[name="nilai_edit"]').val("");
		                    $('[name="upload_at_edit"]').val("");
		        ...
		        $('#btn_hapus').on('click',function(){
		            ...
		            $.ajax({
		            type : "POST",
		            url  : "<?php echo base_url('laporan_akhir/hapus_lapakhir')?>",
		            dataType : "JSON",
		                    data : {kode: kode},
		                    success: function(data){
