      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <div class="table-responsive">
          	...
          	<form action="/myskripsi/olahdata/update" method="post" enctype="multipart/form-data" style="margin-top:0px;">
          	<div class="form-group">

			    <label class="control-label col-xs-3"><b>NIM</b></label>
		        <div class="col-xs-9">
			    <input type="text" name="nim" value="<?php echo $data_proposal->nim; ?>" class="form-control" style="width:460px;">
  			...
  			<div class="form-group">
		        ...
		        <div class="col-xs-9">
			    <input type="text" name="judul" value="<?php echo $data_proposal->judul ?>" class="form-control" style="width:460px;">
			</div></div>

			<div class="form-group">
                <label class="control-label col-xs-3"><b>Konsentrasi</b></label>
                <div class="col-xs-9">
                	<select name="konsentrasi" id="konsentrasi" class="form-control" style="width:460px;">
			...
			<div class="form-group">
			    <label class="control-label col-xs-3" ><b>Proposal</b></label>
		        <div class="col-xs-9">
		        <input type="text" name="proposal" value="<?php echo $data_proposal->proposal ?>" class="form-control" style="width:460px;" readonly><div class="col-xs-9">
			    <?php $fname=$data_proposal->proposal; ?>
				<a href="<?php echo base_url(); ?>olahdata/download/<?php echo $fname; ?>">Download Proposal PDF</a>
			</div></div></div>
			...
			<div class="form-group">
                ...
                <select name="pembimbing_1" id="pembimbing1" class="form-control" style="width:460px;">
                	<option value="">--<?php echo $data_proposal->pembimbing_1 ?>--</option>
			...
			<div class="form-group">
                ...
                <select name="pembimbing_2" id="pembimbing1" class="form-control" style="width:460px;">
                	<option value="">--<?php echo $data_proposal->pembimbing_2 ?>--</option>
                        <option value="Prayudi, MA., PhD">Prayudi, MA., PhD</option>
                        <option value="Dr. Christina Rochayanti, M.Si">Dr. Christina Rochayanti, M.Si</option>
                        <option value="Dr. Puji Lestari S, M.Si">Dr. Puji Lestari S, M.Si</option>
                        <option value="Dra. Siti Fatonah, M.Si">Dra. Siti Fatonah, M.Si</option>
			...
			<input class="btn btn-primary" style="display:block; margin:20px auto;" type="submit" value="SUBMIT" name="proses1" />
          </div></div>
        </div>
      </div>
    </div>
