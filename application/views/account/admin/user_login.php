    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Tabel User Login</div>
        <div class="card-body">
          <div class="table-responsive">
			...
			<tr>
				...
				<td>
					<a href="<?php echo site_url('main/delete_user/'.$key->nim); ?>" class="btn btn-danger btn-sm fa fa-trash" onClick="hapus()" title="Delete" data-toggle="tooltip"></a>
				</td>
			</tr>
			<?php } ?>
              </tbody>
