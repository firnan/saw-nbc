  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="#">Hasil Analisis Proposal</a>
        </li>
        <li class="breadcrumb-item active">Analisis Dosen Pembimbing</li>
      </ol>
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <div class="table-responsive">
          	...
          	<form class="form-horizontal" action="hasil" method="post" role="form">
            	<div class="panel panel-default">
            		<div class="panel-heading"><h6 class="panel-title"><i class="fa fa-pencil"></i> Silahkan Pilih Konsentrasi dan Kompetensi Proposal</h6></div>
            		<div class="panel-body">

            			<div class="form-group">
			                <label class="control-label col-xs-3"><b>Konsentrasi</b></label>
			                <div class="col-xs-9">
			                	<select name="bobot_konsentrasi" id="konsentrasi" class="form-control" style="width:460px;" required>
