	  ...
	  <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/css/jquery.dataTables.css'?>">
				...
				<table class="table table-striped table-bordered" cellspacing="0" width="100%" id="mydata">
					<thead>
						<tr>
							...
							<th style="width:370px; text-align: center;">Konten</th>
							<th style="width:370px; text-align: center;">Status</th>
		        ...
		        <div class="modal fade" id="ModalaAdd" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
		            ...
		            <form class="form-horizontal">
		                <div class="modal-body">
		                    ...
		                    <div class="col-xs-9">
		                            <input name="id_news" id="id_news" class="form-control" type="text" placeholder="Tanggal" style="width:460px;" hidden>
		                        </div>

		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Tanggal</label>
		                        <div class="col-xs-9">
		                            <input name="tanggal" id="tanggal" class="form-control" type="text" placeholder="Tanggal" style="width:460px;" readonly>
		                        </div>
		                    </div>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="col-xs-9">
		                        	<textarea name="konten" id="konten" class="form-control" style="width:460px;" placeholder="Konten" required></textarea>
		                        </div>
		                    </div>
		        ...
		        <div class="modal fade" id="ModalaEdit" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
		            ...
		            <form class="form-horizontal">
		                <div class="modal-body">
		                        ...
		                        <div class="col-xs-9">
		                            <input name="id_news_edit" id="id_news2" class="form-control" type="text" placeholder="Tanggal" style="width:460px;" hidden>
		                        </div>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Tanggal</label>
		                        <div class="col-xs-9">
		                            <input name="tanggal_edit" id="tanggal2" class="form-control" type="text" placeholder="Tanggal" style="width:460px;" readonly>
		                        </div>
		                    </div>
		                    ...
		                    <div class="form-group">
		                        <label class="control-label col-xs-3" >Konten</label>
		                        <div class="col-xs-9">
		                        	<textarea name="konten_edit" id="konten2" class="form-control" style="width:460px;" placeholder="Konten" required></textarea>
		                        </div>
		                    </div>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				tampil_data_news();	//pemanggilan fungsi tampil barang.
				    	...
				    	$.ajax({
				        type  : 'ajax',
				        url   : '<?php echo base_url()?>news/data_news',
				        async : false,
				        dataType : 'json',
				            ...
				            for(i=0; i<data.length; i++){
				                html += '<tr>'+
				                        ...
				                        '<td style="text-align:right;">'+
		                                    '<a href="javascript:;" class="btn btn-info fa fa-pencil item_edit" title="Edit" data-toggle="tooltip" data="'+data[i].id_news+'"></a>'+' '+
		                                    '<a href="javascript:;" class="btn btn-danger fa fa-trash item_hapus" title="Delete" data-toggle="tooltip" data="'+data[i].id_news+'"></a>'+
		                                '</td>'+
				                        '</tr>';
				            }
				            $('#show_data').html(html);
				...
				$('#show_data').on('click','.item_edit',function(){
		            ...
		            $.ajax({
		                type : "GET",
		                url  : "<?php echo base_url('news/get_news')?>",
		                dataType : "JSON",
		                data : {id_news:id_news},
		                success: function(data){
		                	$.each(data,function(id_news, tanggal, judul, perihal, konten, status){
		                    	$('#ModalaEdit').modal('show');
		                    	$('[name="id_news_edit"]').val(data.id_news);
				...
				$('#btn_simpan').on('click',function(){
		            ...
		            $.ajax({
		                type : "POST",
		                url  : "<?php echo base_url('news/simpan_news')?>",
		                dataType : "JSON",
		                data : {id_news:id_news, tanggal:tanggal , judul:judul, perihal:perihal, konten:konten, status:status},
		                success: function(data){
		                    $('[name="id_news"]').val("");
		                    $('[name="tanggal"]').val("");
		                    $('[name="judul"]').val("");
				...
				$('#btn_update').on('click',function(){
		            ...
		            $.ajax({
		                type : "POST",
		                url  : "<?php echo base_url('news/update_news')?>",
		                dataType : "JSON",
		                data : {id_news:id_news, tanggal:tanggal , judul:judul, perihal:perihal, konten:konten, status:status},
		                success: function(data){
		                    $('[name="id_news_edit"]').val("");
		        ...
		        $('#btn_hapus').on('click',function(){
		            ...
		            $.ajax({
		            type : "POST",
		            url  : "<?php echo base_url('news/hapus_news')?>",
		            dataType : "JSON",
		                    data : {kode: kode},
		                    success: function(data){
